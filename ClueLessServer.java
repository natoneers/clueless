        ...
        public void run() {
            try {
                ...
                for (PrintWriter writer : writers) {
                    writer.println("MESSAGE " + name + " has joined the current game");
                }
                writers.add(out);
                ...
                if (name != null) {
                    System.out.println(name + " is leaving the game!");
                    names.remove(name);
                    for (PrintWriter writer : writers) {
                        writer.println("MESSAGE " + name + " has left the Natoneers Game");
                    }
                }
